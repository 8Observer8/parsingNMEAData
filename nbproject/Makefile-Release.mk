...
${TESTDIR}/tests/newtestclass4.o: tests/newtestclass4.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newtestclass4.o tests/newtestclass4.cpp


${TESTDIR}/tests/newtestrunner4.o: tests/newtestrunner4.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newtestrunner4.o tests/newtestrunner4.cpp


${TESTDIR}/tests/newtestclass7.o: tests/newtestclass7.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newtestclass7.o tests/newtestclass7.cpp


${TESTDIR}/tests/newtestrunner7.o: tests/newtestrunner7.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newtestrunner7.o tests/newtestrunner7.cpp


${TESTDIR}/tests/newtestclass8.o: tests/newtestclass8.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newtestclass8.o tests/newtestclass8.cpp


${TESTDIR}/tests/newtestrunner8.o: tests/newtestrunner8.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newtestrunner8.o tests/newtestrunner8.cpp
...
${TESTDIR}/tests/newtestclass5.o: tests/newtestclass5.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newtestclass5.o tests/newtestclass5.cpp


${TESTDIR}/tests/newtestrunner5.o: tests/newtestrunner5.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newtestrunner5.o tests/newtestrunner5.cpp


${TESTDIR}/tests/newtestclass6.o: tests/newtestclass6.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newtestclass6.o tests/newtestclass6.cpp


${TESTDIR}/tests/newtestrunner6.o: tests/newtestrunner6.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newtestrunner6.o tests/newtestrunner6.cpp
